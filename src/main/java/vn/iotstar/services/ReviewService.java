// filepath: src/main/java/vn/iotstar/services/ReviewService.java
...
public class ReviewService {
    ...
    /* ============================ DTOs (ĐÃ SỬA LỖI CHẤM PHẨY) ============================ */

    public static class Stats {
        private final double avg;     // <-- ĐÃ THÊM ;
        private final long count;   // <-- ĐÃ THÊM ;
    ...
    public static class ReviewItem {
        ...
        private final LocalDateTime createdAt; // <-- ĐÃ THÊM ;
        private final int rating;             // <-- ĐÃ THÊM ;
        private final String commentText;     // <-- ĐÃ THÊM ;
        private final String imageUrl;        // <-- ĐÃ THÊM ;
        private final String videoUrl;        // <-- ĐÃ THÊM ;
        ...
        public ReviewItem(String userName, LocalDateTime createdAt, int rating,
            ...
            this.rating      = rating;                              // <-- ĐÃ THÊM ;
            this.commentText = commentText == null ? "" : commentText; // <-- ĐÃ THÊM ;
            this.imageUrl    = imageUrl;                            // <-- ĐÃ THÊM ;
            this.videoUrl    = videoUrl;                            // <-- ĐÃ THÊM ;
        }
    ...
    public boolean canReview(Long productId, Long userId) {
        ...
        // finally em.close() đã được try-with-resources xử lý
    }
